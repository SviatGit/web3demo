...
const ADDRESS = "0x306A9CfcE9157DcEBa9A81B440ebDC1057C32856";
const apikey = "CTKKP7QAKRU6P6T1GJRJFW4XNIH72NVVMC";
const endpoint = "https://api-sepolia.etherscan.io/api";
const nftpng = "https://ipfs.io/ipfs/QmQWNDgUwQUJTzKF1QoscScvs5myQEi4xMkDyRBFZRphwS/";
...
class App extends Component {
  ...
  async componentDidMount() {
	...
	await axios.get((endpoint + `?module=account&action=tokennfttx&contractaddress=${ADDRESS}&page=1&offset=100&startblock=0&endblock=99999999&sort=asc&apikey=${apikey}`))
	.then(outputb => {
                  ...
                  <div className="image-over">
                    ...
                    <div className="card-caption col-12 p-0">
                      <div className="card-body">
                        <h5 className="mb-0">Net2Dev Web3 NFT #{result.tokenID}</h5>
						<h5 className="mb-0 mt-2">Owner Wallet:<p>{result.to}</p></h5>
